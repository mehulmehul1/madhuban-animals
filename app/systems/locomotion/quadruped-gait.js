...
class QuadrupedWalkPattern extends LocomotionPattern {
    ...
    // Removed per-pattern foot target HUD; unified DebugManager draws these to avoid duplicates
...
class BiomechanicalQuadrupedGait extends LocomotionPattern {
    ...
    // Removed per-pattern gait HUD; unified DebugManager now renders gait panels
